...
@Component({
  selector: 'pp-live-order2',
  templateUrl: './live-order2.component.html',
  styleUrls: ['./live-order2.component.scss'],
  animations: [animation],
  host: { '[@animation]': '' },
})
export class LiveOrder2Component implements OnInit {

  userdetails: any;
  url = 'PharmacistReviewRAT/';
  ...
  constructor(
    ...
    this._subheaderService.isDetail = false; this.commonServices.isPage = 3;
  }

  ngOnInit() {
    this._subheaderService.setTitle("RAT Live Orders");
