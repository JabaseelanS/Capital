...
export class LayoutConfig {
	public defaults: LayoutConfigModel = {
		...
		'self': {
			...
			'logo': {
				'dark': './assets/logo/GTS_logo_white_text.png',
				'light': './assets/logo/GTS_logo_white_text.png',
				'brand': './assets/logo/GTS_logo_white_text.png',
				'green': './assets/logo/GTS_logo_white_text.pngg',
			}
		},
